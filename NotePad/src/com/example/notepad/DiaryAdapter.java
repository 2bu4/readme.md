...
import com.example.notepad.DatabaseUtil;
...
public SQLiteDatabase getMDb() {
	...
	public Cursor fetchAllDiariesByDate(String selectDate) {
		String sql = "select time_diaries._id,time_diaries.content,event_types.name,time_diaries.hour||'–° ±'||time_diaries.minute||'∑÷÷”' as count_time,time_diaries.rate from time_diaries,event_types "
